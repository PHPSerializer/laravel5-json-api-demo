...
INSERT INTO `migrations` VALUES ('2015_11_13_181538_create_customers_table',1),('2015_11_13_181538_create_employee_privileges_table',1),('2015_11_13_181538_create_employees_table',1),('2015_11_13_181538_create_inventory_transaction_types_table',1),('2015_11_13_181538_create_inventory_transactions_table',1),('2015_11_13_181538_create_invoices_table',1),('2015_11_13_181538_create_order_details_table',1),('2015_11_13_181538_create_order_details_status_table',1),('2015_11_13_181538_create_orders_table',1),('2015_11_13_181538_create_orders_status_table',1),('2015_11_13_181538_create_orders_tax_status_table',1),('2015_11_13_181538_create_privileges_table',1),('2015_11_13_181538_create_products_table',1),('2015_11_13_181538_create_purchase_order_details_table',1),('2015_11_13_181538_create_purchase_order_status_table',1),('2015_11_13_181538_create_purchase_orders_table',1),('2015_11_13_181538_create_sales_reports_table',1),('2015_11_13_181538_create_shippers_table',1),('2015_11_13_181538_create_strings_table',1),('2015_11_13_181538_create_suppliers_table',1),('2015_11_13_181540_add_foreign_keys_to_employee_privileges_table',1),('2015_11_13_181540_add_foreign_keys_to_inventory_transactions_table',1),('2015_11_13_181540_add_foreign_keys_to_invoices_table',1),('2015_11_13_181540_add_foreign_keys_to_order_details_table',1),('2015_11_13_181540_add_foreign_keys_to_orders_table',1),('2015_11_13_181540_add_foreign_keys_to_purchase_order_details_table',1),('2015_11_13_181540_add_foreign_keys_to_purchase_orders_table',1);
...
INSERT INTO `sales_reports` VALUES (1,'Category','Category','Sales By Category','SELECT DISTINCT [Category] FROM [products] ORDER BY [Category];',0),(2,'country_region','Country/Region','Sales By Country','SELECT DISTINCT [country_region] FROM [customers Extended] ORDER BY [country_region];',0),(3,'Customer ID','Customer','Sales By Customer','SELECT DISTINCT [Company] FROM [customers Extended] ORDER BY [Company];',0),(4,'employee_id','Employee','Sales By Employee','SELECT DISTINCT [Employee Name] FROM [employees Extended] ORDER BY [Employee Name];',0),(5,'Product ID','Product','Sales by Product','SELECT DISTINCT [Product Name] FROM [products] ORDER BY [Product Name];',1);
...
-- Dump completed on 2015-11-13 21:16:55
